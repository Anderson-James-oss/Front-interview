var DatePicker = function(container,ele) {
...
DatePicker.prototype = {
    ...
    init: function() {
        ...
        var p = $('<p>')
            ...
            .css('margin', '0')
            .css('padding', '5px')
            .css('background-color', 'rgb(46,167,224)')
            .css('color', 'white')
    ...
    selectDate: function(date) {
        ...
        if (date.getMonth() === this.date.getMonth()) {
            ...
            this.selectedEle = $(temp).css('background-color', 'rgb(46,167,224)').css('color', 'white');
        } else {
            this.renderByDate(date);
        }
        this.date = date;
        var str = this.formatDate(this.date);
        this.ele.val(str);
        
        setTimeout((function(that){
           setTimeout(function(){
            that.mainEle.parent().get(0).style.display = "none";
        },300);
        })(this),0);
    },
    ...
    renderByDate: function(date) {
        ...
        for (var i = 0; i < 42; i++) {
            ...
            if (dat.getTime() === date.getTime()) {
                ele.css('background-color', 'rgb(46,167,224)').css('color', 'white');
